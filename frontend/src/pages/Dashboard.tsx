...
import ManageTAs from "../components/sysop/ManageTAs";
import Navbarx from "../components/Navbar";

export function Dashboard() {

  const tabsPerProfile = new Map<UserTypes, Array<string>>([
    [UserTypes.Sysop, ["Professors", "Courses", "Users", "Teaching Assistants"]],
    [UserTypes.Student, ["Teaching Assistants"]],
    [UserTypes.TA, ["Teaching Assistants", "Courses"]],
    [UserTypes.Professor, ["Teaching Assistants", "Courses"]],
    [UserTypes.Admin, ["Teaching Assistants", "Courses", "Professors"]],
    ...
    <div>
      ...
      <Navbar expand="lg">
        <Container>
          ...
          <h5 style={{marginRight:"100px"}}>Welcome, {user.firstName}</h5>
